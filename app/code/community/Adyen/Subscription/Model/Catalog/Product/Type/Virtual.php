...
class Adyen_Subscription_Model_Catalog_Product_Type_Virtual extends Mage_Catalog_Model_Product_Type_Virtual
{
    /**
    ...
    /**
     * Prepare selected options for virtual subscription product
     *
     * @param  Mage_Catalog_Model_Product $product
     * @param  Varien_Object $buyRequest
     * @return array
